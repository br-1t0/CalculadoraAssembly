...
_start:
    ...
    cmp al, '2'
    je subtracao
    cmp al, '3'          ; Adiciona comparação para a opção 3 (multiplicação)
    je multiplicacao
    cmp al, '4'          ; Adiciona comparação para a opção 4 (divisão)
    je divisao
...
divisao:
    ...
    mov rax, rbx       ; Coloca o primeiro número (num1) no registrador rax  | rax = rbx
    div rcx            ; Divide rax (dividendo) por rcx (divisor), resultado em rax, resto em rdx
